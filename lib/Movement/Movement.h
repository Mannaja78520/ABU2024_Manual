...
// Motor motor1(20000, 8, 0, motor1PWM, motor1PinA, motor1PinB);
// Motor motor2(20000, 8, 0, motor2PWM, motor2PinA, motor2PinB);
// Motor motor3(20000, 8, 0, motor3PWM, motor3PinA, motor3PinB);
